...
const icons: Record<string, React.ReactNode> = {
  ...
  prompts: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M20 22H6.5A2.5 2.5 0 014 19.5V4a2 2 0 012-2h14v20z"/><path d="M8 7h8"/><path d="M8 11h8"/><path d="M8 15h5"/></svg>,
...
function AppContent() {
  ...
  const systemItems = [
    ...
    { to: '/prompts', icon: icons.prompts, label: t('nav.prompts') },
